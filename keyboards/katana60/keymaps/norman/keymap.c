...
[NORM] = LAYOUT( /* Base */
  ...
  KC_PERC, KC_LGUI, KC_LALT, LT(2, KC_SLSH),            KC_BSPC, KPIR,    KC_SPC,           KC_QUOT, KC_F5,   KC_LEFT, KC_DOWN, KC_RIGHT
    ),
 [QWER] = LAYOUT( /* Base */
...
[FUNT] = LAYOUT(
  ...
  DIM,     KC_LGUI, KC_LALT, KC_TRNS,                   LPTP,    SHRG,    DESK,             TG(3),   NTPD,   OKAY,    THDN,    FIRE
    ),
[SWAP] = LAYOUT(
